...
<nav class="flex items-center justify-between bg-gray-800 py-2 px-4">
    <div class="flex items-center">
      <a href="index.php" class="text-white text-lg font-bold">
        Tours and Travels
      </a>
    </div>
  
    <div class="flex items-center">
      <a href="index.php" class="text-gray-300 hover:text-white mr-4" id="home"> 
        Home
      </a>
  
      <form action="sessionEnd.php" method="POST" id="log">
        <button type="submit" class="bg-gray-900 text-white py-2 px-4 rounded">
          Log Out
        </button>
      </form>
    </div>
  ...
  <br>
       ...
       <!-- <center> <h1 class="text-lg font-bold" >Welcome <?php print($_SESSION['username']);?></h1> </center> -->
    <br>
    <br>
