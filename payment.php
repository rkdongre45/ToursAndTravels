...
<body>
	<div class="uu">
		<div class="container2">
			...
			<form method="post" name="myForm" action="paymentdone.php">
				<div>
      ...
      <!-- <div class="forcredit details">
       ...
       <tr>
          <td> <label>Card no:</label></td>
              <td><input type="number" name="cardno" id="cardno"><br><span style="color: red;">*enter 16 digit card no</span></td>
       </tr>
        <tr>
            <td><label>Cvv no:</label></td>
                 <td><input type="number" name="cvvno" id="cvvno"><br><span style="color: red;">*enter 3 digits</span></td>
        </tr>
        <tr>
