    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/Login_BG.jpg');"></div>
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('images/customerlogin-bg.jpg');"></div>
                <div class="carousel-caption">
                    <h2>...Lets Go...</h2>
                </div>
            </div>
            <div class="item">
                ...
                <div class="fill" style="background-image:url('images/winter.jpg');"></div>
                <div class="carousel-caption">
...
<form action="" method="GET">
  ...
  <div class="row">
    <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <img  src="images/images.jpeg" alt="Card image cap" width="230" height="240">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/delhi.jpeg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/banglore.jpg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/Goa.jpg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img  src="images/kerela.jpg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/kolkata.jpeg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/pondicherry.jpeg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/kashmir.jpeg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
   ...
   <div class="row">
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img  src="images/hyderabad.jpeg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/kodaikanal.jpeg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
    ...
    <!-- <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="images/jaipur.jpeg" alt="Card image cap" width="230" height="240">
            <div class="card-block">
...
$con=  mysqli_connect("localhost", "root", "", "sql file");
