...
<head>
    ...
    background-image: url("images/Customerlogin-bg.jpg") ;
...
<div class="registration">
	...
	<form  name ="myForm" action='regn.php' method='POST' autocomplete="on">
		...
		<table valign="center">
		    ...
		    <tr><td><b>Mobile Number:</b></td><td><input type="number" name="phoneno" placeholder="Mobile number" ><span class="error">*</span></td></tr>
		    <tr><td></td></tr>
		
		    <tr><td></td><td><input type="submit" id="btn" value="SUBMIT" onclick="return validateForm()"></td></tr>
		    <tr><td></td></tr>
...
<script type="text/javascript">
     ...
     var y = document.forms["myForm"]["lastname"].value;
      ...
      var a = document.forms["myForm"]["pass"].value;
        ...
        var inputDate = new Date(db);
		var currentDate = new Date();

		    if(inputDate > currentDate)
		    {
			   alert("Date of Birth should be past date");
			    return false;
		    }
